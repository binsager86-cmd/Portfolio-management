...
LOCAL_DB = r"C:\Users\Sager\OneDrive\Desktop\portfolio_app\mobile-migration\dev_portfolio.db"

PROD_USER = "binsager.86@gmail.com"
PROD_PASS = "Ss.0400148"
...
def get_token(client: httpx.Client) -> str:
    resp = client.post(
        ...
        json={"username": PROD_USER, "password": PROD_PASS},
    )
